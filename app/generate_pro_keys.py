...
async def generate_unique_id(msg: Message):
    try:
        ...
        print(f"generate_pro_keys::generate_unique_id xatolik yuz berdi\n{e}")
...
async def restart_users(msg: Message):
    try:
        ...
        print(f"generate_pro_keys::restart_users xatolik yuz berdi\n{e}")
...
async def update_capacity(msg: Message):
    try:
        ...
        print(f"generate_pro_keys::update_capacity xatolik yuz berdi\n{e}")
...
async def check_key_used(msg: Message):
    try:
        ...
        print(f"generate_pro_keys::check_key_used xatolik yuz berdi\n{e}")
...
async def handle_user_subscription(msg: Message, key_id: int):
    try:
        ...
        print(f"generate_pro_keys::handle_user_subscription xatolik yuz berdi\n{e}")
