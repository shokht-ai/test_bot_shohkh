...
def count_questions_in_excel(file_path: str) -> int:
    ...
    try:
        ...
        print(f"uploading_file::count_questions_in_excel da xatolik\n{e}")
        return 0
...
def extract_questions_from_excel(file_path: str) -> list:
    ...
    try:
        ...
        print(f"uploading_file::extract_questions_from_excel da xatolik\n{e}")
        return []
...
def check_excel_file(file_path: str):
    try:
        ...
        print(f"uploading_file::check_excel_file da xatolik\n{e}")
...
async def check_user_limit(message: Message):
    try:
        ...
        print(f"uploading_file::check_user_limit da xatolik\n{e}")
        return None
