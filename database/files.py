...
async def get_file_name_by_bank(bank_id):
...
async def get_file_id_by_bank_id(bank_id):
    records = await fetch_all(
...
async def get_bank_id_by_file_id(file_id):
    records = await fetch_all(
...
async def get_file_path_by_file_id(file_id):
    records = await fetch_all(
